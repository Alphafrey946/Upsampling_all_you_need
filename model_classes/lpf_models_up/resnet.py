...
from model_classes.lpf_models.blurpool import BlurPool
...
def resnet20_lpf_up(pretrained=False, filter_size=4, layer_channels = [16, 32, 64], pool_only=True, conv_pad_type = 'zeros', dataset_to_train = 'cifar10', **kwargs):
...
def resnet56_lpf_up(pretrained=False, filter_size=4, layer_channels = [16, 32, 64], pool_only=True, conv_pad_type = 'zeros', dataset_to_train = 'cifar10', **kwargs):
...
def resnet18_lpf_up(pretrained=False, filter_size=4, layer_channels = [64, 128, 256, 512], pool_only=True, conv_pad_type = 'zeros', dataset_to_train = 'cifar10', **kwargs):
...
def resnet34_lpf_up(pretrained=False, filter_size=4, layer_channels = [64, 128, 256, 512], pool_only=True, conv_pad_type = 'zeros', dataset_to_train = 'cifar10', **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        filter_size (int): Antialiasing filter size
        pool_only (bool): [True] don't antialias the first downsampling operation (which is costly to antialias)
...
def resnet50_lpf_up(pretrained=False, filter_size=4, layer_channels = [64, 128, 256, 512], pool_only=True, conv_pad_type = 'zeros', dataset_to_train = 'cifar10', **kwargs):
